...
A =  LOAD '/user/hadoopvm/Music_Data_analysis/batch${batchid}/web/' using org.apache.pig.piggybank.storage.XMLLoader('record') as (x:chararray);
...
STORE B INTO '/user/hadoopvm/Music_Data_analysis/batch${batchid}/formattedweb/' USING PigStorage(',');
